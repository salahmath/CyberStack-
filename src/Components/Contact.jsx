...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    // Créer l'URL mailto
    const mailtoLink = `mailto:contact.cyberstack@gmail.com?subject=Message de ${encodeURIComponent(name)}&body=${encodeURIComponent(message)}%0D%0A%0D%0AEnvoyé par: ${encodeURIComponent(email)}`;
